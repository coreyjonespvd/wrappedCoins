  ...
  const [solBalance, setSolBalance] = useState<number | undefined>(undefined);
    ...
    > {
        ...
        return [
            ...
            { id: "#1244", type: "Deposit", amount: "0.020102" },
            ...
            { id: "#1238", type: "Deposit", amount: "0.000714" },
        ];
    }
  ...
  return (
    <div className="flex flex-col h-screen bg-white text-black">
      ...
      <div className="flex-1 p-6 flex flex-col bg-white">
        ...
        {/* Burn Section */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-2 text-black">Burn</h3>
        ...
        {/* Receive Section */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-2 text-black">Receive</h3>
          <div className="flex items-center justify-between mb-2">
